...
// Déplacées depuis classFeatures.en.ts (fichier généré) : ces petites tables
// servent toute l'app (labels.ts localise les noms de classes) et ne doivent
// pas traîner les ~150 KB de descriptions EN derrière elles. Le générateur
// build-class-features-en.py ne les émet plus.
