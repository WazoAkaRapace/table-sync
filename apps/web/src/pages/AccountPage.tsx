          ...
          <div>
            ...
            {user.pendingEmail ? (
              <div className="mt-2 rounded-lg border border-gold-300 bg-gold-100/60 px-3 py-2">
                ...
                <button
                  type="button"
                  className="text-xs font-medium text-blood-600 hover:underline mt-1 inline-flex min-h-11 items-center -mb-2"
              ...
              <div className="mt-2 flex items-center justify-between gap-3">
                ...
                <button
                  type="button"
                  className="text-xs font-medium text-blood-600 hover:underline shrink-0 inline-flex min-h-11 items-center"
                  onClick={resendVerification}
                  disabled={resendingVerify}
                >
                  {resendingVerify
        ...
        >
          {LANGUAGES.map((l) => (
            <button
              ...
              className={`px-4 py-1.5 min-h-11 rounded-md text-sm font-medium transition-colors ${
